package com.example.mobileapklite;
...
import androidx.appcompat.app.AppCompatActivity;  // Import the AppCompatActivity
import androidx.appcompat.widget.Toolbar;   // Import the Toolbar

import com.example.mobileapklite.helper.DbHelper;
...
public class AddEdit extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {  // Use 'switch' instead of 'Switch'
    ...
    private void edit() {
        if (String.valueOf(txt_name.getText()).equals(null) || String.valueOf(txt_name.getText()).equals("") ||
            ...
            SQLite.update(Integer.parseInt(id), txt_name.getText().toString().trim(), txt_address.getText().toString().trim());
            blank();
            finish();
        }
    }
